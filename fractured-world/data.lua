...
if settings.startup["fractured-world-use-quick-startup"].value then
    local quick_preset = settings.startup["fractured-world-quick-startup-preset"].value
    fractured_world:add_preset_data(quick_preset, presets[quick_preset])
    fractured_world:add_preset_data("diamonds", presets["diamonds"])
    fractured_world:add_preset_data("fractured-resources", presets["fractured-resources"])
else
