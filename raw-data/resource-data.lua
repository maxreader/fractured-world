...
local rawResourceData = {
    ...
    bobplates = {
        ...
        ["tin-ore"] = {base_density = 8, starting_rq_factor_multiplier = 1.2},
    ...
    angelsrefining = {
        ...
        ["angels-ore1"] = {base_density = 10, starting_rq_factor_multiplier = 1.5},
        ["angels-ore2"] = {base_density = 7, starting_rq_factor_multiplier = 1.1},
        ["angels-ore3"] = {base_density = 10},
        starting_rq_factor_multiplier = 1.5,
        ["angels-ore4"] = {base_density = 7, starting_rq_factor_multiplier = 1.1},
        ["angels-ore5"] = {base_density = 8, starting_rq_factor_multiplier = 1.2},
        ["angels-ore6"] = {base_density = 8, starting_rq_factor_multiplier = 1.2},
        ["coal"] = {base_density = 8, starting_rq_factor_multiplier = 1.1},
        ["crude-oil"] = {
            base_density = 8,
            base_spots_per_km2 = 1.8,
    ...
    DyWorld = {
        ["stone"] = {base_density = 24, starting_rq_factor_multiplier = 1.35},
        ["coal"] = {base_density = 12, starting_rq_factor_multiplier = 1.25},
        ["iron-ore"] = {base_density = 15, starting_rq_factor_multiplier = 1.5},
        ["copper-ore"] = {base_density = 13, starting_rq_factor_multiplier = 1.45},
        ["nickel-ore"] = {base_density = 12, starting_rq_factor_multiplier = 1.32},
        ["silver-ore"] = {base_density = 8, starting_rq_factor_multiplier = 1.2},
        ["tin-ore"] = {base_density = 9, starting_rq_factor_multiplier = 1.27},
        ["gold-ore"] = {base_density = 5, starting_rq_factor_multiplier = 1.41},
    ...
    pyrawores = {
        borax = {base_density = (20 / 3), base_spots_per_km2 = 3, additional_richness = 10},
        ["ore-quartz"] = {base_density = 15, base_spots_per_km2 = 2.5, additional_richness = 300},
        ["raw-coal"] = {base_density = 15, base_spots_per_km2 = 2.5, additional_richness = 300},
        ["ore-tin"] = {base_density = 15, base_spots_per_km2 = 2.5, additional_richness = 300},
        ["ore-titanium"] = {base_density = 15, base_spots_per_km2 = 2.5, additional_richness = 300},
        niobium = {base_density = 15, base_spots_per_km2 = 1.875, additional_richness = 500},
        ["ore-lead"] = {base_density = 15, base_spots_per_km2 = 1.625, additional_richness = 300},
        ["ore-aluminum"] = {
            base_density = 10,
        ...
        ["ore-nickel"] = {base_density = 10, base_spots_per_km2 = 0.1875, additional_richness = 10},
        ["ore-zinc"] = {base_density = 10, base_spots_per_km2 = 0.1875, additional_richness = 10},
        ...
        ["volcanic-pipe"] = {random_probability = pyRockFreq},
        ["regolites"] = {random_probability = pyRockFreq},
        ["rare-earth-bolide"] = {random_probability = pyRockFreq},
        ["phosphate-rock"] = {random_probability = pyRockFreq},
    ...
    hardCrafting = {
        ...
        ["rich-iron-ore"] = {base_density = 6},
        ["rich-copper-ore"] = {base_density = 4.5}
    }
}
